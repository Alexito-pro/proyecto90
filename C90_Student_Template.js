...
function add() {
	background_imgTag.onload = new Image(); //Define la variable con una nueva imagen
	...
	*/
	car1_imgTag.src = uploadcar1; // Define una función para cargar esta variable
	/*
...
function uploadBackground() {
	...
	*/
	ctx.drawImage(background_imgTag, car1_x, car1_y, car1_width, car_height);
}
